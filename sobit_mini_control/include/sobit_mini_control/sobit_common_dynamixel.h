...
class SobitCommonDynamixel : public hardware_interface::RobotHW {
 protected:
  ...
  // dynamixel::GroupSyncWrite group_sync_write = dynamixel::GroupSyncWrite::GroupSyncWrite(portHandler, packetHandler,
  // ADDR_PRO_GOAL_POSITION, LEN_PRO_GOAL_POSITION);

  // Initialize Groupsyncread instance for Present Position
  // dynamixel::GroupSyncRead group_sync_read = dynamixel::GroupSyncRead::GroupSyncRead(portHandler, packetHandler,
