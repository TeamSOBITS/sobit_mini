...
bool SobitMiniWheelController::controlWheelLinear( const double distance ) {
    try {
...
bool SobitMiniWheelController::controlWheelRotateRad( const double angle_rad ) {
    try {
        while ( curt_odom_.pose.pose.position.x == 0 &
                curt_odom_.pose.pose.position.y == 0 &
                curt_odom_.pose.pose.position.z == 0 &
...
bool SobitMiniWheelController::controlWheelRotateDeg( const double angle_deg ) {
